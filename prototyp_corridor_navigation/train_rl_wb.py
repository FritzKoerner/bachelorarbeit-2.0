...
def get_cfgs():
    env_cfg = DictConfig({
        ...
        "corridor_pair_separation_min": 1.0,
        "corridor_pair_separation_max": 2.0,
        # Corridor geometry (all metres). Corridor is fixed-axis along +X.
        "corridor_x_range": [0.0, 13.0],
        "corridor_y_range": [-3.0, 3.0],
        "corridor_z_range": [0.3, 6.0],
        "corridor_spawn_x_range": [0.5, 5.5],
        "corridor_spawn_y_range": [-2.5, 2.5],
        "corridor_spawn_z": 5.0,
        "corridor_target_pos": [12.0, 0.0, 1.0],
        "corridor_slice_centres": [3.5, 6.0, 8.5, 11.0],
