...
def get_train_cfg(exp_name, max_iterations):
    return {
        ...
        # W&B logging
        "logger": "wandb",
        "wandb_project": "drone-simple-discrete",
...
def get_cfgs(env_v2=False):
    ...
    obs_cfg = {
        "num_obs": 17,      # rel_pos(3) + quat(4) + lin_vel(3) + ang_vel(3) + last_actions(4)
        "obs_scales": {
            "rel_pos":    1 / 15.0,
            "lin_vel":    0.4,
            "ang_vel":    1 / 3.14159,
...
def main():
    ...
    if args.env_v2:
        train_cfg["wandb_project"] = "drone-simple-discrete-v2"
...
python train_rl_simple_discrete_wb.py -B 4096 --max_iterations 401
