...
from train_rl_discrete_wb import DictConfig  # needed to unpickle cfgs.pkl
...
def main():
    ...
    parser.add_argument("--hpc",              nargs="?", const="list", default=None,
                        help="HPC run name (e.g. 'discrete_02'). No value = list runs.")
    ...
    parser.add_argument("--wandb_project",    type=str, default="drone-discrete")
...
python eval_rl_discrete_wb.py

# List available HPC runs
python eval_rl_discrete_wb.py --hpc

# Evaluate HPC run (latest checkpoint)
python eval_rl_discrete_wb.py --hpc discrete_02

# Evaluate HPC run (specific checkpoint)
python eval_rl_discrete_wb.py --hpc discrete_02 --ckpt 400

# Evaluate specific checkpoint
python eval_rl_discrete_wb.py --ckpt 300

# Custom episode count
python eval_rl_discrete_wb.py --num_episodes 200 --num_envs 100

# Visual viewer (1 env, 10 episodes, no W&B)
python eval_rl_discrete_wb.py --vis
python eval_rl_discrete_wb.py --ckpt 300 --vis
"""
