"""
CoordinateLandingSimpleDiscreteEnv: Single-categorical discrete action variant.
...
class CoordinateLandingSimpleDiscreteEnv(CoordinateLandingEnv):

    def build(self):
        super().build()
        # Runner reads num_actions for policy output dim and rollout storage.
        # Internal buffers (self.actions, self.last_actions) remain 4D from parent.
        self.num_actions = 1
