"""
ObstacleAvoidanceDiscreteEnv: Discrete action variant of ObstacleAvoidanceEnv.

Inherits all physics, obstacles, depth camera, rewards, observations, and reset
logic from the continuous environment.  The only change: the RL agent outputs
4 ternary discrete actions instead of 4 continuous floats.
...
class ObstacleAvoidanceDiscreteEnv(ObstacleAvoidanceEnv):
